                            ...
                            <div className="grid gap-6 lg:grid-cols-2 lg:gap-8">
                                {features.data.map((feature) => (
                                    <Link
                                        ...
                                        className="flex items-start justify-around  rounded-lg p-6 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] ring-1 ring-white/[0.05] transition duration-300 hover:text-black/70 hover:ring-black/20 focus:outline-none focus-visible:ring-[#FF2D20] lg:pb-10 dark:bg-slate-800 dark:ring-slate-900 dark:hover:text-white/70 dark:hover:ring-slate-700 dark:focus-visible:ring-[#FF2D20]"
                                    >
